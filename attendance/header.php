    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="EasyPHP/examples/examples.php"><i class="fa fa-th-large"></i> <span class="nav-label">Attendance reports</span></a>
                </li>
                <li>
                    <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Result</span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="../pdf/gen_result.php">Generate Result</a></li>
                        <li><a href="../pdf/view_result.php">View Result</a></li>
                    </ul>
                </li>
                <li>
